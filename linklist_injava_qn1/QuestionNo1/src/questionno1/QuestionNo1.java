 ...
 void search(int d)
{
 ...
 public void concatinate(Node list2)
{
	...
	System.out.println("****Concatination has been Sucessfully Done****");
}
}
...
public class QuestionNo1 {
    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
         ...
         System.out.println("press 9 : Conatination");
        ...
        switch(choice)
         {
            ...
            case 9:
            {
                obj.concatinate(obj1);
                System.out.println("This is after conatination");
                obj.display();
                System.out.println("");
                obj1.display();
                break;
