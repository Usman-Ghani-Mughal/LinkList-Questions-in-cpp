    ...
    public static void main(String[] args) {
        ...
        Scanner sc=new Scanner(System.in);
            ...
            while(true)
            {
             ...
             System.out.println("press 9 : checkOcurrance");
            ...
            switch(choice)
             {
                ...
                case 9:
                {
                    ...
                    val=sc.nextInt();
                    el=obj.checkOcurance(val);
                    System.out.println("This Element : "+val+" occurs this times in list : "+el);
                    break;
                }
                default:
                {
